...
## Recent Updates
- 2025/04/05：Update Qwen `q4f32` + `dynamic_axes`, the inference speed of `ONNX-CPU-q4f32` is only about 10% slower than `MNN-CPU-q4f16`.
...
1. **Download Models:**
   ...
   - Quick Try: [DeepSeek-R1-Distill-Qwen-1.5B-Android](https://drive.google.com/file/d/1arFsaFv04zGIMjCUwRJ30M_6o4BPrTR1/view?usp=sharing) / [Qwen2VL-2B](https://drive.google.com/file/d/11POekmCRLsYk9B_ivJ9st5zRIqjJKlov/view?usp=sharing)
...
| Harmony 4  | P40          | Kirin_990_5G-CPU        | Qwen2.5-1.5B-Instruct<br>q4f32<br>dynamic | 20 token/s  |
...
## 最近更新
- 2025/04/05: 更新 Qwen `q4f32` + `dynamic_axes`，`ONNX-CPU-q4f32`的推理速度仅慢于`MNN-CPU-q4f16`约10%。
