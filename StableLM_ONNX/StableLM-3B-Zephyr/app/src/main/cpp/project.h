...
const std::string file_name_A = "StableLM_Zephyr_3B_1024_A.ort";
const std::string file_name_B = "StableLM_Zephyr_3B_1024_B.ort";
...
const std::string vocab_file = "/data/user/0/com.example.myapplication/cache/vocab_StableLM_Zephyr.txt";  // We have moved the vocab.txt from assets to the cache folder in Java process.
