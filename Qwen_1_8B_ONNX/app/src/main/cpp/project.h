...
const std::string file_name_A = "Qwen_1_8B_256.ort";
const int max_token_history = 256;  // Please set this value to match the model name flag.
const int start_id = 151644;
const int end_id_0 = 151643;
const int end_id_1 = 151645;
const int past_key_value_size = 49152 * max_token_history;  // 24 * 16 * 128
const int single_chat_limit = 85; // It is recommended to set it to max_token_history/3, and use phrases like 'go ahead', 'go on', or 'and then?' to continue answering."
