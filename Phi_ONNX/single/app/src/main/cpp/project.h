...
const std::string file_name_A_external = "Phi3_mini_1024_A.onnx.data";   // If using external data to load the model, provide the file name; otherwise, set to "NONE". If contains many parts, please modify the project.cpp line 278-280.
