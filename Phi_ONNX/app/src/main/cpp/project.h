...
const std::string file_name_A = "Phi3_mini_1024_A.ort";
const std::string file_name_B = "Phi3_mini_1024_B.ort";
...
const int past_key_value_size = 16 * 32 * 96 * max_token_history;
...
//const int hidden_state_buffer_size = max_token_history * hidden_size * sizeof(Ort::Float16_t);
const int hidden_state_buffer_size = max_token_history * hidden_size * sizeof(float);
