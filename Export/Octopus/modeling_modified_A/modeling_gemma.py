...
class GemmaForCausalLM(GemmaPreTrainedModel):
    ...
    def forward(
        ...
        return (torch.cat((self.model.embed_tokens(input_ids[:, :ids_len]) * self.scale_emb, torch.zeros((1, self.max_seq_len - ids_len, self.hidden_size), dtype=torch.float32)), dim=-2),)
