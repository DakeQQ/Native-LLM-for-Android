...
path = 'C:/Users/Downloads/Octopus_ONNX'  # set the folder path where the Octopus_V2 whole project downloaded.
# Replace the original "modeling_gemma.py" with the modified "modeling_gemma.py", which stored at the folder "modeling_modified".

onnx_model = 'C:/Users/Downloads/Octopus_ONNX/Octopus.onnx'  # Assign a path where the exported Octopus_V2 model stored.
