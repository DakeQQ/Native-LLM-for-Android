...
const std::string file_name_A = "OctopusV2_2B_1024_A.ort";
const std::string file_name_B = "OctopusV2_2B_1024_B.ort";
const std::string file_name_C = "OctopusV2_2B_1024_C.ort";
...
const std::string vocab_file = "/data/user/0/com.example.myapplication/cache/vocab_OctopusV2.txt";  // We have moved the vocab.txt from assets to the cache folder in Java process.
