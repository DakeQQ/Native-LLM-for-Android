...
class GemmaSdpaAttention(GemmaAttention):
    ...
    def forward(
        ...
        return self.o_proj(torch.matmul(nn.functional.softmax(
            ...
            dtype=torch.float32), value_states).transpose(0, 1).reshape(1, ids_len, self.hidden_size).contiguous()), save_key_states.half(), save_value_states.half()
...
class GemmaForCausalLM(GemmaPreTrainedModel):
    ...
    def forward(
        ...
        return (torch.argmax(self.lm_head(hidden_states)),)
