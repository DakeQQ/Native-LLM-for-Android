...
if "Qwen2.5" in path or "qwen2.5" in path or "VL-3B" in path or "vl-3b" in path:
    shutil.copyfile("./modeling_modified/v2.5/part_ABCD/modeling_qwen2_5_vl.py", python_package_path + "/transformers/models/qwen2_5_vl/modeling_qwen2_5_vl.py")
    shutil.copyfile("export_config.py", python_package_path + "/transformers/models/qwen2_5_vl/export_config.py")
    from transformers import Qwen2_5_VLForConditionalGeneration     # transformers >= 4.49.0 or pip install git+https://github.com/huggingface/transformers
else:
    shutil.copyfile("./modeling_modified/v2/part_ABCD/modeling_qwen2_vl.py", python_package_path + "/transformers/models/qwen2_vl/modeling_qwen2_vl.py")
    shutil.copyfile("export_config.py", python_package_path + "/transformers/models/qwen2_vl/export_config.py")
    from transformers import Qwen2VLForConditionalGeneration        # transformers <= 4.47.1
