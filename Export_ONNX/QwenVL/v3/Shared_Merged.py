"""Build standalone Qwen3-VL merged ONNX graphs with shared initializers.

The Qwen3-VL language path differs from text-only Qwen v3 because vision features are
