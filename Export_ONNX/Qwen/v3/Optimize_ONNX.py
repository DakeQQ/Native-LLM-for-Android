...
WEIGHT_ONLY_METHOD             = "Q4"                                # "Q2" | "Q4" | "Q8" | "F16" | "F32" | "DYNAMIC".
WEIGHT_ONLY_ALGORITHM          = "AFFINE_REFINE_V2"                  # "AFFINE_REFINE_V2" | "DEFAULT" | "RTN" | "HQQ" | "k_quant". AFFINE_REFINE_V2 supports Q4/Q8; k_quant/RTN are Q4-only.
...
class Plan:
    ...
    algo:                str  | None            = None     # AFFINE_REFINE_V2 | DEFAULT | RTN | HQQ | k_quant (AFFINE_REFINE_V2/k_quant/RTN: Q4 only)
...
def _main_quantization_ops(
    ...
    # RTN, and HQQ backends quantize MatMul only. Bundle finalization reconstructs
    # the tied embedding from the quantized lm_head and drops its separate float weight.
...
MODEL_PLANS: dict[str, Plan] = {
    ...
    _PRIMARY_MERGED_MODEL: Plan(
        method=WEIGHT_ONLY_METHOD, external=True, optimize=True,
