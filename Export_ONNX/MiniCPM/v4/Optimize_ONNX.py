"""Optimize MiniCPM4 ONNX modules and rebuild the shared merged bundle."""
...
DOWNLOAD_PATH                  = str(Path.home() / "Downloads" / "MiniCPM4-0.5B")  # Model dir (attention fusion); "NONE" to skip.
...
UNIFY_EMBED_LMHEAD             = False                               # Scaling differs at Gather/MatMul; keep the tied base tensor logically separate.
...
def _load_unified_primary(
    ...
    # MiniCPM4 is tied, but embedding/final-logit activation scales differ.
