...
# Load the model
shutil.copyfile('./modeling_modified/modeling_minicpm.py', path + "/modeling_minicpm.py")
...
max_seq_len = 1024  # Please modify the same variable, which declared in the modified modeling_minicpm.py on line 1020, at the same time.
