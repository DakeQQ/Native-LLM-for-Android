...
transformers_gemma2_path = 'C:/Users/dake/.conda/envs/python_311/Lib/site-packages/transformers/models/gemma2/modeling_gemma2.py'  # The original modeling_qwen2.py path which was stored in the transformers python package.
...
max_seq_len = 1024  # Please modify the same variable, which declared in the modified modeling_gemma2.py on line 998, at the same time.
