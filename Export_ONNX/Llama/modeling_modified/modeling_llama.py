...
class LlamaRMSNorm(nn.Module):
    ...
    def forward(self, hidden_states):
        return self.weight * hidden_states / torch.sqrt((hidden_states * hidden_states).mean(dim=-1, keepdim=True))
...
class LlamaDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        return hidden_states_temp + self.mlp(
            self.post_attention_layernorm(hidden_states_temp)), past_key_states, past_value_states
