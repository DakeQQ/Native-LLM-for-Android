...
Java_com_example_myapplication_MainActivity_Run_1LLM(JNIEnv *env, jclass clazz, jstring jquery,
    ...
    }
    {
        ...
        std::vector<float> before_hidden_states_temp;
        ...
        if (add_prompt) {
            ...
            ort_runtime_A->CreateTensorWithDataAsOrtValue(
                    ...
                    &input_tensors_A[5]);
            before_hidden_states_temp.resize(before_hidden_states_size, 0.f);
            ort_runtime_A->CreateTensorWithDataAsOrtValue(
                    memory_info,
                    reinterpret_cast<void*>(before_hidden_states_temp.data()), before_hidden_states_buffer_size,
                    input_dims_A[8].data(), input_dims_A[8].size(), input_types_A[8],
                    &input_tensors_A[8]);
        } else {
            ort_runtime_A->CreateTensorWithDataAsOrtValue(
                    memory_info,
            ...
            ort_runtime_A->CreateTensorWithDataAsOrtValue(
                    memory_info,
                    reinterpret_cast<void*>(reinterpret_cast<float*> (before_hidden_states)), before_hidden_states_buffer_size,
                    input_dims_A[8].data(), input_dims_A[8].size(), input_types_A[8],
                    &input_tensors_A[8]);
        }
        ort_runtime_A->CreateTensorWithDataAsOrtValue(
        ...
        ort_runtime_A->CreateTensorWithDataAsOrtValue(
                ...
                input_dims_A[9].data(), input_dims_A[9].size(), input_types_A[9],
                &input_tensors_A[9]);
