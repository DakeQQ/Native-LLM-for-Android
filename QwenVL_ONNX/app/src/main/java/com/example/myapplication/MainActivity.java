...
public class MainActivity extends AppCompatActivity {
    private static final boolean low_memory_mode = false;  // Enable it for reduce peak memory consume. But only works for (*.onnx + external_data), not for *.ort format.
...
//                mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AF_REGIONS, focus_area);
    ...
    private static native boolean Load_Models_E(AssetManager assetManager, boolean USE_XNNPACK, boolean LOW_MEMORY_MODE);
    private static native void Run_LLM_AD(short[] pixel_values);
