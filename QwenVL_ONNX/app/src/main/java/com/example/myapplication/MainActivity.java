...
//                mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AF_REGIONS, focus_area);
    ...
    private static native boolean Load_Models_B(AssetManager assetManager, boolean USE_XNNPACK);
    private static native boolean Load_Models_C(AssetManager assetManager, boolean USE_XNNPACK);
    private static native boolean Load_Models_D(AssetManager assetManager, boolean USE_XNNPACK);
    private static native boolean Load_Models_E(AssetManager assetManager, boolean USE_XNNPACK);
