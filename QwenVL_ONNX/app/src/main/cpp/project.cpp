...
Java_com_example_myapplication_MainActivity_Run_1LLM_1AD(JNIEnv *env, jclass clazz, jshortArray pixel_values) {
    jshort* pixels = env->GetShortArrayElements(pixel_values, nullptr);
    ...
    ort_runtime_A->CreateTensorWithDataAsOrtValue(
            memory_info, reinterpret_cast<void*>(pixels), rgbSize_short,
...
Java_com_example_myapplication_MainActivity_Load_1Models_1E(JNIEnv *env, jclass clazz,
    ...
    OrtSessionOptions *session_options_E;
    {
        ...
        ort_runtime_E->AddSessionConfigEntry(session_options_E, "session.dynamic_block_base",
                                             "2");                                                              // One block can contain 1 or more cores, and sharing 1 job.
