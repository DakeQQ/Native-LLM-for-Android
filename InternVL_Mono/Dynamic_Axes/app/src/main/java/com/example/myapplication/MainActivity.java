...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String file_name_vocab = "vocab_InternVL_Mono.txt";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (low_memory_mode) {
            ...
            success = Load_Models_D(null, false, true);
            if (success) {
                success =  Load_Models_A(null, false, false, false, false, true) && Load_Models_B(null, false, true) && Load_Models_C(null, false, true);
            }
        } else {
            success = Load_Models_D(mgr, false, false);
            if (success) {
                success = Load_Models_A(mgr, false, false, false, false, false) && Load_Models_B(mgr, false, false) && Load_Models_C(mgr, false, false);
            }
        }
        if (success) {
...
//                mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AF_REGIONS, focus_area);
    ...
    private static native boolean Load_Models_A(AssetManager assetManager, boolean USE_FLOAT_MODEL, boolean USE_QNN, boolean USE_DSP_NPU, boolean USE_XNNPACK, boolean LOW_MEMORY_MODE);
