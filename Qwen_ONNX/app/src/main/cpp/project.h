...
float attention_mask = -65504.f;                             // Disable if using all fp16 format
...
const int single_chat_limit = 341;                           // You can adjust it. If you set the value greater than (max_token_history / 3), the previous context might be cleared.
