...
public final class MemBandwidth {
    ...
    static {
        try {
            ...
            Log.i(TAG, "membw native library loaded");
     ...
     */
    public static String runMemoryBandwidthTest(int arraySizeMillions, int iterations,
        ...
        setCpuGroupMode(CPU_GROUP_TOTAL);
    ...
    private static void appendGroupReport(StringBuilder report, int mode, int arraySizeMillions,
        ...
        setCpuGroupMode(mode);
        report.append(runMemoryBandwidthTestForCurrentGroup(arraySizeMillions, iterations, threadCount));
    }

    private static native void setCpuGroupMode(int mode);
