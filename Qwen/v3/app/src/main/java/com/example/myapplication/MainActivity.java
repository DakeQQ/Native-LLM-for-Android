...
public class MainActivity extends AppCompatActivity {
    ...
    private class LLMThread extends Thread {
        ...
        @Override
        public void run() {
            LLM_Talk = Run_LLM(usrInputText,true, clear_flag, think_mode);
            usrInputText = "";
            if (clear_flag) {
                clear_flag = false;
            }
            ...
            while (chatting) {
                ...
                LLM_Talk = Run_LLM(usrInputText, false, clear_flag, think_mode);
            }
        }
    }
    ...
    private static native String Run_LLM(String QUERY, boolean ADD_PROMPT, boolean CLEAR, boolean USE_THINK);
}
