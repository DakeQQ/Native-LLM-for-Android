...
const std::string file_name_A_external = "MiniCPM_2B_dpo_1024.onnx.data";   // If using external data to load the model, provide the file name; otherwise, set to "NONE". If contains many parts, please modify the project.cpp line 334-336.
