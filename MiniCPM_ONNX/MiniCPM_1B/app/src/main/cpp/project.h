...
const std::string file_name_A = "MiniCPM_1B_1024.ort";
const std::string file_name_A_external = "NONE";   // If using external data to load the model, provide the file name; otherwise, set to "NONE". If contains many parts, please modify the project.cpp line 318-320.
const int max_token_history = 1024; // Please set this value to match the model name flag.
const int start_id = 1;
const int end_id_0 = 2;
const size_t past_key_value_size = 26624 * max_token_history; // 52 * 8 * 64
...
const std::string vocab_file = "/data/user/0/com.example.myapplication/cache/vocab_MiniCPM_1B.txt"; // We have moved the vocab.txt from assets to the cache folder in Java process.
