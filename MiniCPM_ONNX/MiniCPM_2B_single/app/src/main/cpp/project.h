...
int64_t ids_len = 0;
//Ort::Float16_t attention_mask = Ort::Float16_t(-65504.f);                 // Enable if using all fp16 format, and project.cpp line: 71, 156, 167, 407
float attention_mask = -65504.f;                                            // Disable if using all fp16 format, and project.cpp line: 72, 157, 168, 408
const std::string file_name_A = "MiniCPM_2B_dpo_1024.onnx";
const std::string file_name_A_external = "NONE";                            // If using external data to load the model, provide the file name; otherwise, set to "NONE". If contains many parts, please modify the project.cpp line 323-326.
