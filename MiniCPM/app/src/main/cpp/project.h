...
// Model File Settings
const std::string file_name_A = "MiniCPM.onnx";
const std::string file_name_A_external = "d37d0104-5b9d-11f0-a4f2-bc091bee2d5c.data";  // The demo model is MiniCPM-0.5B

// Model Configuration
const int num_layers = 24;                                                        // Transformer layers. Refer to config.json for the value. MiniCPM4-0.5B = 24; MiniCPM4-8B = 32; BitCPM4-0.5B = 24; BitCPM4-1B = 52;
